...
% Complementary, extra color defs
% TODO -- move from the below theorem definitions up here... where they belong
...
\fi
\declaretheorem[style=nordbg4box,name=Theorem,numbered=no]{thm*}
\declaretheorem[style=nordbg4box,name=Theorem,sibling=thm]{theorem}
\declaretheorem[style=nordbg4box,name=Theorem,numbered=no]{theorem*}
\declaretheorem[style=nordbg4box,name=Proposition,sibling=thm]{prop}
\declaretheorem[style=nordbg4box,name=Proposition,numbered=no]{prop*}
\declaretheorem[style=nordbg4box,name=Proposition,sibling=thm]{proposition}
\declaretheorem[style=nordbg4box,name=Proposition,numbered=no]{proposition*}
\declaretheorem[style=nordbg4box,name=Problem,numberwithin=section]{prob}
\declaretheorem[style=nordbg4box,name=Lemma,sibling=thm]{lem}
\declaretheorem[style=nordbg4box,name=Lemma,numbered=no]{lem*}
\declaretheorem[style=nordbg4box,name=Lemma,sibling=thm]{lemma}
\declaretheorem[style=nordbg4box,name=Lemma,numbered=no]{lemma*}
...
\declaretheorem[style=nordauroraGreenbox,name=Inventory,sibling=thm]{inv}
\declaretheorem[style=nordauroraGreenbox,name=Inventory,numbered=no]{inv*}
\declaretheorem[style=nordauroraGreenbox,name=Inventory,sibling=thm]{inventory}
\declaretheorem[style=nordauroraGreenbox,name=Inventory,numbered=no]{inventory*}
\declaretheorem[style=nordauroraGreenbox,name=Notation,sibling=thm]{notation}
\declaretheorem[style=nordauroraGreenbox,name=Notation,numbered=no]{notation*}
\declaretheorem[style=nordauroraGreenbox,name=Definition,sibling=thm]{defihelper}
\declaretheorem[style=nordauroraGreenbox,name=Definition,numbered=no]{defihelper*}

\declaretheorem[style=nordfrost4box,name=Example,sibling=thm]{ex}
\declaretheorem[style=nordfrost4box,name=Example,numbered=no]{ex*}
\declaretheorem[style=nordfrost4box,name=Example,sibling=thm]{example}
\declaretheorem[style=nordfrost4box,name=Example,numbered=no]{example*}
\declaretheorem[style=nordfrost4box,name=Non-Example,sibling=thm]{nex}
\declaretheorem[style=nordfrost4box,name=Non-Example,numbered=no]{nex*}
\declaretheorem[style=nordfrost4box,name=Non-Definition,sibling=thm]{ndefi}
\declaretheorem[style=nordfrost4box,name=Non-Definition,numbered=no]{ndefi*}
