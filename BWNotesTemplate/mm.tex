...
\else
	\declaretheorem[name=Theorem,within=chapter]{thm}
\fi
\declaretheorem[name=Theorem,numbered=no]{thm*}
\declaretheorem[name=Theorem,sibling=thm]{theorem}
...
\declaretheorem[name=Convention,sibling=thm]{conv}
\declaretheorem[name=Convention,numbered=no]{conv*}
\declaretheorem[name=Convention,sibling=thm]{convention}
\declaretheorem[name=Convention,numbered=no]{convention*}

\declaretheorem[name=Axiom,sibling=thm]{ax}
\declaretheorem[name=Axiom,numbered=no]{ax*}
\declaretheorem[name=Axiom,sibling=thm]{axiom}
\declaretheorem[name=Axiom,numbered=no]{axiom*}
\declaretheorem[name=Notation,sibling=thm]{notation}
\declaretheorem[name=Notation,numbered=no]{notation*}
\declaretheorem[name=Definition,sibling=thm]{defihelper}
\declaretheorem[name=Definition,numbered=no]{defihelper*}
...
\declaretheorem[name=Exercise,sibling=thm]{exercise}
\declaretheorem[name=Exercise,numbered=no]{exercise*}
\declaretheorem[name=Exercise,sibling=thm]{exe}
\declaretheorem[name=Exercise,numbered=no]{exe*}

\declaretheorem[name=Remark,sibling=thm]{remark}
\declaretheorem[name=Remark,numbered=no]{remark*}
\declaretheorem[name=Quote,sibling=thm]{quot}
\declaretheorem[name=Quote,numbered=no]{quot*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% /THM BOXES
...
\declaretheorem[name=Definition,numbered=no]{defi*}
\declaretheorem[name=Definition,sibling=thm]{definition}
